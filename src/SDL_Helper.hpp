...
namespace SDLH{
    ...
    void LoadFont(TTF_Font **font, int size, std::string path);
    void UnloadFonts();
    ...
    void DrawAlignedImage(SDL_Texture *texture, int x, int y, Alignments align);

    void DrawAlphaText(TTF_Font *font, int x, int y, Alignments align, SDL_Color colour, uint8_t alpha, const char *text);
    void DrawText(TTF_Font *font, int x, int y, Alignments align, SDL_Color colour, const char *text);
    void DrawTextf(TTF_Font *font, int x, int y, Alignments align, SDL_Color colour, const char* text, ...);
    void DrawOutlineTextf(TTF_Font *font, TTF_Font *outline_font, int x, int y, Alignments align, SDL_Color colour, SDL_Color outline_colour, const char* text, ...);
    void DrawOutlineAlphaTextf(TTF_Font *font, TTF_Font *outline_font, int x, int y, Alignments align, SDL_Color colour, SDL_Color outline_colour, uint8_t alpha, const char* text, ...);
